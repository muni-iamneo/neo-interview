...
def set_session_config(session_id: str, eleven_agent_id: str, dynamic_variables: Optional[Dict[str, str]] = None, max_interview_minutes: Optional[int] = None):
    ...
    logger.info("Session config set: session=%s agent=%s max_minutes=%s", session_id, eleven_agent_id, max_interview_minutes)
